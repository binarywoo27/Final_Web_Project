  ...
  <b-row class="mb-1">
    <b-col style="text-align: left">
      <b-form @submit="onSubmit" @reset="onReset">
        ...
        <b-form-group id="content-group" label-for="file">
          이미지: {{ article.filename }} <br />
          <!-- <input
            type="file"
            id="content"
            accept="image/*"
          ...
          <input
            ...
            ref="fileRef"
          />
          <div v-if="this.type === 'modify' && files.length > 0">
        ...
        <b-button
          type="submit"
          variant="dark"
          class="m-1 btn-custom"
          v-if="this.type === 'register'"
          >글작성</b-button
        >
        <b-button type="submit" variant="dark" class="m-1 btn-custom" v-else
          >글수정</b-button
        >
...
export default {
  ...
  methods: {
    ...
    selectFile(event) {
      ...
      // this.$refs.fileImage.attributes("");
      this.src = null;
    },
    onSubmit(event) {
    ...
    async registArticle() {
      ...
      console.log("db에[ 저장된 파일명:" + DBfilename);
